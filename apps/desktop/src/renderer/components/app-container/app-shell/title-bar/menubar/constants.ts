...
export const FILE_MENU_ITEMS: readonly FileMenuItem[] = [
  { action: 'create-file', labelKey: 'menu.file.createFile' },
  { action: 'import-file', labelKey: 'menu.file.importFile' },
  { action: 'create-project', labelKey: 'menu.file.createProject' }
];
